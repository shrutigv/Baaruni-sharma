...
window.addEventListener("load", function() {
	...
	var colorPoints = [
		new ColorPoint(0, 0, new Color(229, 149, 199)),
		new ColorPoint(0, 1, new Color(229, 149, 199)),
		new ColorPoint(1, 0, new Color(229, 149, 199)),
		new ColorPoint(1, 1, new Color(229, 149, 199))
	];
